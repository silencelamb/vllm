...
define ptx_kernel void @wrapped_concatenate(ptr noalias align 16 dereferenceable(4194304) %0, ptr noalias align 16 dereferenceable(4194304) %1, ptr noalias align 16 dereferenceable(4194304) %2, ptr noalias align 16 dereferenceable(4194304) %3, ptr noalias align 16 dereferenceable(4194304) %4, ptr noalias align 16 dereferenceable(4194304) %5, ptr noalias align 16 dereferenceable(4194304) %6, ptr noalias align 16 dereferenceable(4194304) %7, ptr noalias align 16 dereferenceable(4194304) %8, ptr noalias align 128 dereferenceable(37748736) %9) #0 {
  ...
  %12 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !3
  %13 = udiv i32 %12, 4
...
90:                                               ; preds = %88
  ...
  %98 = load bfloat, ptr %97, align 2, !invariant.load !2
  br label %122
...
110:                                              ; preds = %99
  ...
  %118 = load bfloat, ptr %117, align 2, !invariant.load !2
  br label %119
...
232:                                              ; preds = %220
  ...
  %241 = load bfloat, ptr %240, align 2, !invariant.load !2
  br label %242
...
259:                                              ; preds = %257
  ...
  %262 = load bfloat, ptr %261, align 2, !invariant.load !2
  br label %273
...
318:                                              ; preds = %306
  ...
  %327 = load bfloat, ptr %326, align 2, !invariant.load !2
  br label %328
...
333:                                              ; preds = %331
  ...
  %342 = load bfloat, ptr %341, align 2, !invariant.load !2
  br label %368
...
345:                                              ; preds = %343
  ...
  %354 = load bfloat, ptr %353, align 2, !invariant.load !2
  br label %365
...
355:                                              ; preds = %343
  ...
  %364 = load bfloat, ptr %363, align 2, !invariant.load !2
  br label %365
...
382:                                              ; preds = %380
  ...
  %385 = load bfloat, ptr %384, align 2, !invariant.load !2
  br label %396
...
401:                                              ; preds = %399
  ...
  %410 = load bfloat, ptr %409, align 2, !invariant.load !2
  br label %421
...
441:                                              ; preds = %429
  ...
  %450 = load bfloat, ptr %449, align 2, !invariant.load !2
  br label %451
...
456:                                              ; preds = %454
  ...
  %465 = load bfloat, ptr %464, align 2, !invariant.load !2
  br label %491
...
478:                                              ; preds = %466
  ...
  %487 = load bfloat, ptr %486, align 2, !invariant.load !2
  br label %488
...
define ptx_kernel void @gemm_fusion_dot_35_0(ptr noalias align 128 dereferenceable(37748736) %arg0, ptr noalias align 128 dereferenceable(294912) %arg1) #4 {
...
1265:                                             ; preds = %359
  ...
  %1320 = mul i64 %1318, 9216
  %1321 = mul i64 %1319, 9216
...
declare ptx_kernel void @fusion_129_impl(ptr, ptr, ptr, ptr, ptr, ptr) #5
...
define ptx_kernel void @fusion_129(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(32768) %arg1, ptr noalias align 128 dereferenceable(294912) %arg2, ptr noalias align 16 dereferenceable(2048) %arg3, ptr noalias align 128 dereferenceable(32768) %arg4) #7 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
...
define ptx_kernel void @loop_convert_fusion_8(ptr noalias align 128 dereferenceable(196608) %0, ptr noalias align 128 dereferenceable(98304) %1) #0 {
  ...
  %7 = mul i32 %6, 128
  %8 = add i32 %7, %3
  %9 = call bfloat @fused_convert_8_param_0_256(ptr %0, i32 %5, i32 %8)
  ...
  %19 = add i32 %8, 3072
  %20 = call bfloat @fused_convert_8_param_0_256(ptr %0, i32 %5, i32 %19)
  %21 = fmul float %10, %18
...
define internal bfloat @fused_convert_8_param_0_256(ptr noalias %0, i32 %1, i32 %2) {
  %4 = mul i32 %1, 6144
  %5 = add i32 %4, %2
...
define ptx_kernel void @loop_add_fusion(ptr noalias align 128 dereferenceable(294912) %0, ptr noalias align 128 dereferenceable(32768) %1, ptr noalias align 128 dereferenceable(32768) %2, ptr noalias align 128 dereferenceable(32768) %3, ptr noalias align 128 dereferenceable(65536) %4) #0 {
...
declare ptx_kernel void @fusion_125_impl(ptr, ptr, ptr, ptr, ptr) #5

define ptx_kernel void @fusion_125(ptr noalias align 128 dereferenceable(65536) %arg0, ptr noalias align 16 dereferenceable(4) %arg1, ptr noalias align 16 dereferenceable(2048) %arg2, ptr noalias align 128 dereferenceable(32768) %arg3) #7 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %3 = addrspacecast ptr %arg2 to ptr addrspace(1)
  %4 = addrspacecast ptr %arg3 to ptr addrspace(1)
...
declare ptx_kernel void @fusion_119_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #5

define ptx_kernel void @fusion_119(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 16 dereferenceable(2048) %arg1, ptr noalias align 128 dereferenceable(32768) %arg2, ptr noalias align 128 dereferenceable(294912) %arg3, ptr noalias align 128 dereferenceable(65536) %arg4, ptr noalias align 128 dereferenceable(32768) %arg5, ptr noalias align 128 dereferenceable(32768) %arg6, ptr noalias align 128 dereferenceable(32768) %arg7) #7 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %3 = addrspacecast ptr %arg2 to ptr addrspace(1)
  %4 = addrspacecast ptr %arg3 to ptr addrspace(1)
...
define ptx_kernel void @loop_add_fusion_1(ptr noalias align 128 dereferenceable(294912) %0, ptr noalias align 128 dereferenceable(32768) %1, ptr noalias align 128 dereferenceable(32768) %2, ptr noalias align 128 dereferenceable(65536) %3, ptr noalias align 128 dereferenceable(32768) %4, ptr noalias align 128 dereferenceable(32768) %5) #0 {
...
declare ptx_kernel void @fusion_115_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr) #5
...
declare ptx_kernel void @fusion_113_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #5
...
declare ptx_kernel void @triton_softmax_11_0_impl(ptr, ptr, ptr, ptr) #8

define ptx_kernel void @triton_softmax_11_0(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(131072) %arg1, ptr noalias align 128 dereferenceable(65536) %arg2) #9 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %3 = addrspacecast ptr %arg2 to ptr addrspace(1)
...
define ptx_kernel void @input_concatenate_fusion(ptr noalias align 128 dereferenceable(65536) %0, ptr noalias align 16 dereferenceable(256) %1, ptr noalias align 16 dereferenceable(10485760) %2, ptr noalias align 16 dereferenceable(64) %3, ptr noalias align 128 dereferenceable(32768) %4) #0 {
  ...
  %20 = fmul float %16, %19
  %21 = call float @fused_concatenate_convert_613_17(ptr %0, ptr %1, ptr %2, ptr %3, i32 %8, i32 %9)
  %22 = fmul float %20, %21
  %23 = add i32 %9, 64
  %24 = add i32 %14, 64
  ...
  %30 = fmul float %26, %29
  %31 = call float @fused_concatenate_convert_613_17(ptr %0, ptr %1, ptr %2, ptr %3, i32 %8, i32 %23)
  %32 = fmul float %30, %31
  %33 = fsub float %22, %32
  ...
  %39 = fmul float %36, %38
  %40 = call float @fused_concatenate_convert_613_17(ptr %0, ptr %1, ptr %2, ptr %3, i32 %8, i32 %9)
  %41 = fmul float %39, %40
  %42 = load float, ptr %15, align 4, !invariant.load !2
  %43 = load bfloat, ptr %17, align 2, !invariant.load !2
  %44 = fpext bfloat %43 to float
  %45 = fmul float %42, %44
  %46 = call float @fused_concatenate_convert_613_17(ptr %0, ptr %1, ptr %2, ptr %3, i32 %8, i32 %23)
  %47 = fmul float %45, %46
  %48 = fadd float %41, %47
...
define internal float @fused_concatenate_convert_613_17(ptr noalias %0, ptr noalias %1, ptr noalias %2, ptr noalias %3, i32 %4, i32 %5) {
