...
define ptx_kernel void @gemm_fusion_dot_7_0(ptr noalias align 16 dereferenceable(4194304) %arg0, ptr noalias align 16 dereferenceable(4194304) %arg1, ptr noalias align 128 dereferenceable(262144) %arg2) local_unnamed_addr #3 {
  ...
  %.v = select i1 %9, ptr addrspace(1) %arg0115, ptr addrspace(1) %arg1117
  %10 = add i32 %8, -1024
  ...
  %19 = lshr i32 %13, 3
  %20 = and i32 %19, 7
  %21 = icmp samesign ult i32 %13, 64
  ...
  %39 = or disjoint i64 %12, %34
  %40 = or disjoint i64 %12, %35
  %41 = or disjoint i64 %12, %36
  %42 = or disjoint i64 %12, %37
  %43 = shl nsw i64 %39, 11
  %44 = shl nsw i64 %40, 11
  %45 = shl nsw i64 %41, 11
  %46 = shl nsw i64 %42, 11
  %47 = or disjoint i64 %43, %38
  %48 = or disjoint i64 %44, %38
  %49 = or disjoint i64 %45, %38
  %50 = or disjoint i64 %46, %38
  %51 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %47
  %52 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %48
  %53 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %49
  %54 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %50
  %55 = select i1 %.not, i32 0, i32 72
  %56 = select i1 %16, i32 0, i32 144
  %57 = select i1 %18, i32 0, i32 288
  %58 = or disjoint i32 %56, %55
  %59 = xor i32 %58, %33
  %60 = xor i32 %59, %57
  %61 = select i1 %21, i32 0, i32 512
  %62 = or disjoint i32 %60, %61
  %63 = zext nneg i32 %62 to i64
  %64 = getelementptr inbounds nuw bfloat, ptr addrspace(3) @global_smem, i64 %63
  %65 = or disjoint i32 %33, 1024
  %66 = xor i32 %58, %65
  %67 = xor i32 %66, %57
  %68 = or disjoint i32 %67, %61
  %69 = zext nneg i32 %68 to i64
  %70 = getelementptr inbounds nuw bfloat, ptr addrspace(3) @global_smem, i64 %69
  %71 = or disjoint i32 %33, 2048
  %72 = xor i32 %58, %71
  %73 = xor i32 %72, %57
  %74 = or disjoint i32 %73, %61
  %75 = zext nneg i32 %74 to i64
  %76 = getelementptr inbounds nuw bfloat, ptr addrspace(3) @global_smem, i64 %75
  %77 = or disjoint i32 %33, 3072
  %78 = xor i32 %58, %77
  %79 = xor i32 %78, %57
  %80 = or disjoint i32 %79, %61
  %81 = zext nneg i32 %80 to i64
  %82 = getelementptr inbounds nuw bfloat, ptr addrspace(3) @global_smem, i64 %81
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %64, ptr addrspace(1) %51, i32 16) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %70, ptr addrspace(1) %52, i32 16) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %76, ptr addrspace(1) %53, i32 16) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %82, ptr addrspace(1) %54, i32 16) #9
  tail call void asm sideeffect "cp.async.commit_group ;", ""() #9
  %83 = add i64 %43, %38
  %84 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %83
  %85 = getelementptr i8, ptr addrspace(1) %84, i64 128
  %86 = add i64 %44, %38
  %87 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %86
  %88 = getelementptr i8, ptr addrspace(1) %87, i64 128
  %89 = add i64 %45, %38
  %90 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %89
  %91 = getelementptr i8, ptr addrspace(1) %90, i64 128
  %92 = add i64 %46, %38
  %93 = getelementptr bfloat, ptr addrspace(1) %.v, i64 %92
  %94 = getelementptr i8, ptr addrspace(1) %93, i64 128
  tail call void @llvm.nvvm.barrier0()
  %95 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 8192), i64 %63
  %96 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 8192), i64 %69
  %97 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 8192), i64 %75
  %98 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 8192), i64 %81
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %95, ptr addrspace(1) %85, i32 16) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %96, ptr addrspace(1) %88, i32 16) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %97, ptr addrspace(1) %91, i32 16) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %98, ptr addrspace(1) %94, i32 16) #9
  tail call void asm sideeffect "cp.async.commit_group ;", ""() #9
  %99 = getelementptr i8, ptr addrspace(1) %84, i64 256
  %100 = getelementptr i8, ptr addrspace(1) %87, i64 256
  %101 = getelementptr i8, ptr addrspace(1) %90, i64 256
  %102 = getelementptr i8, ptr addrspace(1) %93, i64 256
  tail call void @llvm.nvvm.barrier0()
  %103 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 16384), i64 %63
  %104 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 16384), i64 %69
  %105 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 16384), i64 %75
  %106 = getelementptr inbounds nuw bfloat, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @global_smem, i64 16384), i64 %81
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %103, ptr addrspace(1) %99, i32 16) #9
  ...
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %105, ptr addrspace(1) %101, i32 16) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %106, ptr addrspace(1) %102, i32 16) #9
  tail call void asm sideeffect "cp.async.commit_group ;", ""() #9
  tail call void asm sideeffect "cp.async.wait_group 0x2;", ""() #9
  tail call void @llvm.nvvm.barrier0()
  %107 = select i1 %28, i32 0, i32 72
  %108 = select i1 %30, i32 0, i32 144
  %109 = or disjoint i32 %107, %108
  %110 = select i1 %.not3, i32 0, i32 288
  %111 = shl nuw nsw i32 %14, 6
  %112 = or disjoint i32 %110, %111
  %113 = or disjoint i32 %112, %109
  %114 = lshr exact i32 %15, 1
  %115 = xor i32 %113, %114
  %116 = select i1 %21, i32 0, i32 1024
  %117 = or disjoint i32 %115, %116
  %118 = zext nneg i32 %117 to i64
  %119 = or disjoint i32 %107, 16
  %120 = xor i32 %119, %108
  %121 = or disjoint i32 %111, %120
  %122 = or disjoint i32 %121, %110
  %123 = or disjoint i32 %116, %114
  %124 = xor i32 %123, %122
  %125 = zext nneg i32 %124 to i64
  %126 = or disjoint i32 %109, 32
  %127 = xor i32 %126, %110
  %128 = or disjoint i32 %127, %111
  %129 = xor i32 %123, %128
  %130 = zext nneg i32 %129 to i64
  %131 = or disjoint i32 %107, 48
  %132 = or disjoint i32 %110, %108
  %133 = xor i32 %132, %131
  %134 = or disjoint i32 %133, %111
  %135 = xor i32 %123, %134
  %136 = zext nneg i32 %135 to i64
  %137 = or disjoint i32 %113, 2048
  %138 = xor i32 %123, %137
  %139 = zext nneg i32 %138 to i64
  %140 = or disjoint i32 %107, 2064
  %141 = xor i32 %140, %108
  %142 = or disjoint i32 %111, %141
  %143 = or disjoint i32 %142, %110
  %144 = xor i32 %123, %143
  %145 = zext nneg i32 %144 to i64
  %146 = or disjoint i32 %109, 2080
  %147 = xor i32 %146, %110
  %148 = or disjoint i32 %147, %111
  %149 = xor i32 %123, %148
  %150 = zext nneg i32 %149 to i64
  %151 = or disjoint i32 %107, 2096
  %152 = xor i32 %132, %151
  %153 = or disjoint i32 %152, %111
  %154 = xor i32 %123, %153
  %155 = zext nneg i32 %154 to i64
  %156 = trunc i32 %13 to i3
  %157 = zext i3 %156 to i64
  %158 = shl nuw nsw i64 %157, 4
  %159 = add i32 %22, %20
  %160 = add i32 %159, 48
  %161 = zext nneg i32 %160 to i64
  %162 = add i64 %12, %161
  %163 = shl nsw i64 %162, 12
  %164 = add nuw nsw i64 %163, 384
  %scevgep = getelementptr i8, ptr addrspace(1) %.v, i64 %164
  %165 = add i32 %159, 32
  %166 = zext nneg i32 %165 to i64
  %167 = add i64 %12, %166
  %168 = shl nsw i64 %167, 12
  %169 = add nuw nsw i64 %168, 384
  %scevgep123 = getelementptr i8, ptr addrspace(1) %.v, i64 %169
  %170 = add i32 %159, 16
  %171 = zext nneg i32 %170 to i64
  %172 = add i64 %12, %171
  %173 = shl nsw i64 %172, 12
  %174 = add nuw nsw i64 %173, 384
  %scevgep127 = getelementptr i8, ptr addrspace(1) %.v, i64 %174
  %175 = zext nneg i32 %159 to i64
  %176 = add i64 %12, %175
  %177 = shl nsw i64 %176, 12
  %178 = add nuw nsw i64 %177, 384
  %scevgep131 = getelementptr i8, ptr addrspace(1) %.v, i64 %178
  br label %179

179:                                              ; preds = %0, %179
  %lsr.iv135 = phi i32 [ -64, %0 ], [ %184, %179 ]
  %lsr.iv132 = phi ptr addrspace(1) [ %scevgep131, %0 ], [ %scevgep133, %179 ]
  %lsr.iv128 = phi ptr addrspace(1) [ %scevgep127, %0 ], [ %scevgep129, %179 ]
  %lsr.iv124 = phi ptr addrspace(1) [ %scevgep123, %0 ], [ %scevgep125, %179 ]
  %lsr.iv = phi ptr addrspace(1) [ %scevgep, %0 ], [ %scevgep121, %179 ]
  %180 = phi ptr addrspace(3) [ @global_smem, %0 ], [ %378, %179 ]
  %181 = phi i32 [ 0, %0 ], [ %375, %179 ]
  %182 = phi i32 [ 2, %0 ], [ %364, %179 ]
  %183 = phi { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } [ zeroinitializer, %0 ], [ %361, %179 ]
  %184 = add i32 %lsr.iv135, 64
  %185 = icmp samesign ult i32 %184, 1856
  %186 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %118
  %187 = ptrtoint ptr addrspace(3) %186 to i64
  %188 = trunc i64 %187 to i32
  %189 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %188) #9
  ...
  %194 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %125
  %195 = ptrtoint ptr addrspace(3) %194 to i64
  %196 = trunc i64 %195 to i32
  %197 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %196) #9
  %198 = extractvalue { i32, i32, i32, i32 } %197, 0
  %199 = extractvalue { i32, i32, i32, i32 } %197, 1
  %200 = extractvalue { i32, i32, i32, i32 } %197, 2
  %201 = extractvalue { i32, i32, i32, i32 } %197, 3
  %202 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %130
  %203 = ptrtoint ptr addrspace(3) %202 to i64
  %204 = trunc i64 %203 to i32
  %205 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %204) #9
  %206 = extractvalue { i32, i32, i32, i32 } %205, 0
  %207 = extractvalue { i32, i32, i32, i32 } %205, 1
  %208 = extractvalue { i32, i32, i32, i32 } %205, 2
  %209 = extractvalue { i32, i32, i32, i32 } %205, 3
  %210 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %136
  %211 = ptrtoint ptr addrspace(3) %210 to i64
  %212 = trunc i64 %211 to i32
  %213 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %212) #9
  %214 = extractvalue { i32, i32, i32, i32 } %213, 0
  %215 = extractvalue { i32, i32, i32, i32 } %213, 1
  %216 = extractvalue { i32, i32, i32, i32 } %213, 2
  %217 = extractvalue { i32, i32, i32, i32 } %213, 3
  %218 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %139
  %219 = ptrtoint ptr addrspace(3) %218 to i64
  %220 = trunc i64 %219 to i32
  %221 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %220) #9
  %222 = extractvalue { i32, i32, i32, i32 } %221, 0
  %223 = extractvalue { i32, i32, i32, i32 } %221, 1
  %224 = extractvalue { i32, i32, i32, i32 } %221, 2
  %225 = extractvalue { i32, i32, i32, i32 } %221, 3
  %226 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %145
  %227 = ptrtoint ptr addrspace(3) %226 to i64
  %228 = trunc i64 %227 to i32
  %229 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %228) #9
  ...
  %234 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %150
  %235 = ptrtoint ptr addrspace(3) %234 to i64
  %236 = trunc i64 %235 to i32
  %237 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %236) #9
  %238 = extractvalue { i32, i32, i32, i32 } %237, 0
  %239 = extractvalue { i32, i32, i32, i32 } %237, 1
  %240 = extractvalue { i32, i32, i32, i32 } %237, 2
  %241 = extractvalue { i32, i32, i32, i32 } %237, 3
  %242 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %180, i64 %155
  %243 = ptrtoint ptr addrspace(3) %242 to i64
  %244 = trunc i64 %243 to i32
  %245 = tail call { i32, i32, i32, i32 } asm sideeffect "ldmatrix.sync.aligned.m8n8.x4.shared.b16 {$0, $1, $2, $3}, [$4];", "=r,=r,=r,=r,r"(i32 %244) #9
  ...
  %250 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 0
  %251 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 1
  %252 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 2
  %253 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 3
  %254 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 4
  %255 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 5
  %256 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 6
  %257 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 7
  %258 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 8
  %259 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 9
  %260 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 10
  %261 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 11
  %262 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 12
  %263 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 13
  %264 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 14
  %265 = extractvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %183, 15
  %266 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %250, float %251, float %252, float %253, i32 %190, i32 %191, i32 %192, i32 %193, i32 0, i32 0) #9
  %267 = extractvalue { float, float, float, float } %266, 0
  %268 = extractvalue { float, float, float, float } %266, 1
  %269 = extractvalue { float, float, float, float } %266, 2
  %270 = extractvalue { float, float, float, float } %266, 3
  %271 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %254, float %255, float %256, float %257, i32 %190, i32 %191, i32 %192, i32 %193, i32 0, i32 0) #9
  %272 = extractvalue { float, float, float, float } %271, 0
  %273 = extractvalue { float, float, float, float } %271, 1
  %274 = extractvalue { float, float, float, float } %271, 2
  %275 = extractvalue { float, float, float, float } %271, 3
  %276 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %258, float %259, float %260, float %261, i32 %222, i32 %223, i32 %224, i32 %225, i32 0, i32 0) #9
  ...
  %281 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %262, float %263, float %264, float %265, i32 %222, i32 %223, i32 %224, i32 %225, i32 0, i32 0) #9
  ...
  %286 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %267, float %268, float %269, float %270, i32 %198, i32 %199, i32 %200, i32 %201, i32 0, i32 0) #9
  ...
  %291 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %272, float %273, float %274, float %275, i32 %198, i32 %199, i32 %200, i32 %201, i32 0, i32 0) #9
  ...
  %296 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %277, float %278, float %279, float %280, i32 %230, i32 %231, i32 %232, i32 %233, i32 0, i32 0) #9
  ...
  %301 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %282, float %283, float %284, float %285, i32 %230, i32 %231, i32 %232, i32 %233, i32 0, i32 0) #9
  ...
  %306 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %287, float %288, float %289, float %290, i32 %206, i32 %207, i32 %208, i32 %209, i32 0, i32 0) #9
  ...
  %311 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %292, float %293, float %294, float %295, i32 %206, i32 %207, i32 %208, i32 %209, i32 0, i32 0) #9
  ...
  %316 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %297, float %298, float %299, float %300, i32 %238, i32 %239, i32 %240, i32 %241, i32 0, i32 0) #9
  ...
  %321 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %302, float %303, float %304, float %305, i32 %238, i32 %239, i32 %240, i32 %241, i32 0, i32 0) #9
  ...
  %326 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %307, float %308, float %309, float %310, i32 %214, i32 %215, i32 %216, i32 %217, i32 0, i32 0) #9
  ...
  %331 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %312, float %313, float %314, float %315, i32 %214, i32 %215, i32 %216, i32 %217, i32 0, i32 0) #9
  ...
  %336 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %317, float %318, float %319, float %320, i32 %246, i32 %247, i32 %248, i32 %249, i32 0, i32 0) #9
  ...
  %341 = tail call { float, float, float, float } asm sideeffect "mma.sync.aligned.m16n8k16.row.col.f32.bf16.bf16.f32 { $0, $1, $2, $3 }, { $8, $9, $10, $11 }, { $12, $13 }, { $4, $5, $6, $7 };", "=f,=f,=f,=f,0,1,2,3,r,r,r,r,r,r"(float %322, float %323, float %324, float %325, i32 %246, i32 %247, i32 %248, i32 %249, i32 0, i32 0) #9
  ...
  %346 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } undef, float %327, 0
  %347 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %346, float %328, 1
  %348 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %347, float %329, 2
  %349 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %348, float %330, 3
  %350 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %349, float %332, 4
  %351 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %350, float %333, 5
  %352 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %351, float %334, 6
  %353 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %352, float %335, 7
  %354 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %353, float %337, 8
  %355 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %354, float %338, 9
  %356 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %355, float %339, 10
  %357 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %356, float %340, 11
  %358 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %357, float %342, 12
  %359 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %358, float %343, 13
  %360 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %359, float %344, 14
  %361 = insertvalue { float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float } %360, float %345, 15
  %362 = add i32 %182, 1
  %363 = icmp slt i32 %362, 3
  %364 = select i1 %363, i32 %362, i32 0
  %scevgep134 = getelementptr i8, ptr addrspace(1) %lsr.iv132, i64 %158
  %scevgep130 = getelementptr i8, ptr addrspace(1) %lsr.iv128, i64 %158
  %scevgep126 = getelementptr i8, ptr addrspace(1) %lsr.iv124, i64 %158
  %scevgep122 = getelementptr i8, ptr addrspace(1) %lsr.iv, i64 %158
  %365 = shl i32 %364, 12
  %366 = sext i32 %365 to i64
  %367 = getelementptr bfloat, ptr addrspace(3) @global_smem, i64 %366
  tail call void @llvm.nvvm.barrier0()
  %368 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %367, i64 %63
  %369 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %367, i64 %69
  %370 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %367, i64 %75
  %371 = getelementptr inbounds nuw bfloat, ptr addrspace(3) %367, i64 %81
  %372 = select i1 %185, i32 16, i32 0
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %368, ptr addrspace(1) %scevgep134, i32 %372) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %369, ptr addrspace(1) %scevgep130, i32 %372) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %370, ptr addrspace(1) %scevgep126, i32 %372) #9
  tail call void asm sideeffect "cp.async.cg.shared.global [ $0 + 0 ], [ $1 + 0 ], 0x10, $2;", "r,l,r"(ptr addrspace(3) %371, ptr addrspace(1) %scevgep122, i32 %372) #9
  tail call void asm sideeffect "cp.async.commit_group ;", ""() #9
  %373 = add i32 %181, 1
  ...
  %scevgep121 = getelementptr i8, ptr addrspace(1) %lsr.iv, i64 128
  %scevgep125 = getelementptr i8, ptr addrspace(1) %lsr.iv124, i64 128
  %scevgep129 = getelementptr i8, ptr addrspace(1) %lsr.iv128, i64 128
  %scevgep133 = getelementptr i8, ptr addrspace(1) %lsr.iv132, i64 128
  %379 = icmp samesign ult i32 %184, 1984
  br i1 %379, label %179, label %380

380:                                              ; preds = %179
  %381 = icmp ult i32 %13, 64
  %382 = mul i32 %2, 16
  %.decomposed = sub i32 %.frozen, %382
  %383 = sdiv i32 %.decomposed, %5
  tail call void asm sideeffect "cp.async.wait_group 0x0;", ""() #9
  tail call void @llvm.nvvm.barrier0()
  %384 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %327) #9
  %385 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %328) #9
  %386 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %329) #9
  %387 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %330) #9
  %388 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %332) #9
  %389 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %333) #9
  %390 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %334) #9
  %391 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %335) #9
  %392 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %337) #9
  %393 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %338) #9
  %394 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %339) #9
  %395 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %340) #9
  %396 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %342) #9
  %397 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %343) #9
  %398 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %344) #9
  %399 = tail call bfloat asm "cvt.rn.bf16.f32 $0, $1;", "=h,r"(float %345) #9
  %400 = shl nsw i32 %383, 5
  %401 = sext i32 %8 to i64
  %402 = sext i32 %400 to i64
  %403 = or disjoint i64 %401, %38
  %404 = or disjoint i64 %402, %34
  %405 = or disjoint i64 %402, %35
  %406 = getelementptr bfloat, ptr addrspace(1) %arg2119, i64 %403
  %.idx = shl nsw i64 %404, 12
  %407 = getelementptr i8, ptr addrspace(1) %406, i64 %.idx
  %.idx2 = shl nsw i64 %405, 12
  %408 = getelementptr i8, ptr addrspace(1) %406, i64 %.idx2
  %409 = shl nuw nsw i32 %13, 7
  %410 = and i32 %409, 384
  %411 = lshr i32 %13, 2
  %412 = and i32 %411, 3
  %413 = or disjoint i32 %412, %410
  %414 = lshr exact i32 %15, 2
  %415 = or disjoint i32 %413, %414
  %416 = shl nuw nsw i32 %17, 4
  %417 = or disjoint i32 %415, %416
  %418 = select i1 %381, i32 0, i32 16
  %419 = or disjoint i32 %417, %418
  %420 = and i32 %32, 504
  %421 = or disjoint i32 %420, %61
  %422 = lshr i32 %417, 3
  %423 = add nuw nsw i32 %422, %419
  %424 = zext nneg i32 %423 to i64
  %425 = getelementptr inbounds nuw bfloat, ptr addrspace(3) @global_smem, i64 %424
  %426 = bitcast bfloat %384 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) %425, <1 x i16> %426, i1 true) #9
  %427 = or disjoint i32 %419, 64
  %428 = lshr i32 %427, 3
  %429 = and i32 %428, 536870904
  %430 = zext nneg i32 %429 to i64
  %431 = zext nneg i32 %419 to i64
  %432 = add i64 %430, %431
  %433 = getelementptr bfloat, ptr addrspace(3) @global_smem, i64 %432
  %434 = getelementptr inbounds i8, ptr addrspace(3) %433, i64 128
  %435 = bitcast bfloat %385 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %434, <1 x i16> %435, i1 true) #9
  %436 = zext nneg i32 %422 to i64
  %437 = add i64 %431, %436
  %438 = getelementptr bfloat, ptr addrspace(3) @global_smem, i64 %437
  %439 = getelementptr inbounds i8, ptr addrspace(3) %438, i64 16
  %440 = bitcast bfloat %386 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %439, <1 x i16> %440, i1 true) #9
  %441 = or disjoint i32 %419, 72
  %442 = lshr i32 %441, 3
  %443 = and i32 %442, 536870904
  %444 = zext nneg i32 %443 to i64
  %445 = add i64 %444, %431
  %446 = getelementptr bfloat, ptr addrspace(3) @global_smem, i64 %445
  %447 = getelementptr inbounds i8, ptr addrspace(3) %446, i64 144
  %448 = bitcast bfloat %387 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %447, <1 x i16> %448, i1 true) #9
  %449 = getelementptr inbounds i8, ptr addrspace(3) %438, i64 64
  %450 = bitcast bfloat %392 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %449, <1 x i16> %450, i1 true) #9
  %451 = or disjoint i32 %419, 96
  %452 = lshr i32 %451, 3
  %453 = and i32 %452, 536870904
  %454 = zext nneg i32 %453 to i64
  %455 = add i64 %454, %431
  %456 = getelementptr bfloat, ptr addrspace(3) @global_smem, i64 %455
  %457 = getelementptr inbounds i8, ptr addrspace(3) %456, i64 192
  %458 = bitcast bfloat %393 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %457, <1 x i16> %458, i1 true) #9
  %459 = getelementptr inbounds i8, ptr addrspace(3) %438, i64 80
  %460 = bitcast bfloat %394 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %459, <1 x i16> %460, i1 true) #9
  %461 = or disjoint i32 %419, 104
  %462 = lshr i32 %461, 3
  %463 = and i32 %462, 536870904
  %464 = zext nneg i32 %463 to i64
  %465 = add i64 %464, %431
  %466 = getelementptr bfloat, ptr addrspace(3) @global_smem, i64 %465
  %467 = getelementptr inbounds i8, ptr addrspace(3) %466, i64 208
  %468 = bitcast bfloat %395 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %467, <1 x i16> %468, i1 true) #9
  tail call void @llvm.nvvm.barrier0()
  %469 = lshr exact i32 %421, 3
  %470 = and i32 %469, 120
  %471 = add nuw nsw i32 %470, %421
  %472 = zext nneg i32 %471 to i64
  %473 = getelementptr inbounds nuw bfloat, ptr addrspace(3) @global_smem, i64 %472
  %474 = load <4 x i32>, ptr addrspace(3) %473, align 16
  tail call void @llvm.nvvm.barrier0()
  %475 = bitcast bfloat %388 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) %425, <1 x i16> %475, i1 true) #9
  %476 = bitcast bfloat %389 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %434, <1 x i16> %476, i1 true) #9
  %477 = bitcast bfloat %390 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %439, <1 x i16> %477, i1 true) #9
  %478 = bitcast bfloat %391 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %447, <1 x i16> %478, i1 true) #9
  %479 = bitcast bfloat %396 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %449, <1 x i16> %479, i1 true) #9
  %480 = bitcast bfloat %397 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %457, <1 x i16> %480, i1 true) #9
  %481 = bitcast bfloat %398 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %459, <1 x i16> %481, i1 true) #9
  %482 = bitcast bfloat %399 to <1 x i16>
  tail call void asm sideeffect "@$2 st.shared.b16 [ $0 + 0 ], $1;", "r,h,b"(ptr addrspace(3) nonnull %467, <1 x i16> %482, i1 true) #9
  tail call void @llvm.nvvm.barrier0()
  %483 = load <4 x i32>, ptr addrspace(3) %473, align 16
  %.extract = extractelement <4 x i32> %474, i64 0
  %.extract27 = extractelement <4 x i32> %474, i64 1
  %.extract29 = extractelement <4 x i32> %474, i64 2
  %.extract31 = extractelement <4 x i32> %474, i64 3
  tail call void asm sideeffect "st.global.v4.b32 [ $4 + 0 ], { $0, $1, $2, $3 };", "r,r,r,r,l"(i32 %.extract, i32 %.extract27, i32 %.extract29, i32 %.extract31, ptr addrspace(1) %407) #9
  %.extract33 = extractelement <4 x i32> %483, i64 0
  %.extract35 = extractelement <4 x i32> %483, i64 1
  %.extract37 = extractelement <4 x i32> %483, i64 2
  %.extract39 = extractelement <4 x i32> %483, i64 3
  tail call void asm sideeffect "st.global.v4.b32 [ $4 + 0 ], { $0, $1, $2, $3 };", "r,r,r,r,l"(i32 %.extract33, i32 %.extract35, i32 %.extract37, i32 %.extract39, ptr addrspace(1) %408) #9
  ret void
}
...
define ptx_kernel void @fusion_39(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(131072) %arg1, ptr noalias align 128 dereferenceable(262144) %arg2, ptr noalias align 16 dereferenceable(2048) %arg3, ptr noalias align 128 dereferenceable(131072) %arg4) local_unnamed_addr #5 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define ptx_kernel void @loop_convert_fusion_1(ptr noalias readonly align 128 captures(none) dereferenceable(786432) %0, ptr noalias writeonly align 128 captures(none) dereferenceable(393216) %1) local_unnamed_addr #0 {
...
define ptx_kernel void @fusion_38(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(131072) %arg1, ptr noalias align 128 dereferenceable(262144) %arg2, ptr noalias align 128 dereferenceable(131072) %arg3, ptr noalias align 16 dereferenceable(2048) %arg4, ptr noalias align 128 dereferenceable(131072) %arg5) local_unnamed_addr #5 {
...
define ptx_kernel void @triton_softmax_4_0(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(524288) %arg1, ptr noalias align 128 dereferenceable(262144) %arg2) local_unnamed_addr #5 {
...
!7 = !{i32 0, i32 1536}
!8 = !{!9}
!9 = distinct !{!9, !10, !"fused_convert_1_param_0_149: argument 0"}
!10 = distinct !{!10, !"fused_convert_1_param_0_149"}
!11 = !{!12}
!12 = distinct !{!12, !13, !"fused_convert_1_param_0_149: argument 0"}
!13 = distinct !{!13, !"fused_convert_1_param_0_149"}
!14 = !{i32 0, i32 256}
!15 = !{!16}
!16 = distinct !{!16, !17, !"fused_concatenate_convert_197_7: argument 0"}
!17 = distinct !{!17, !"fused_concatenate_convert_197_7"}
!18 = !{!19}
!19 = distinct !{!19, !17, !"fused_concatenate_convert_197_7: argument 1"}
!20 = !{!21}
!21 = distinct !{!21, !22, !"fused_concatenate_convert_197_7: argument 0"}
!22 = distinct !{!22, !"fused_concatenate_convert_197_7"}
!23 = !{!24}
!24 = distinct !{!24, !22, !"fused_concatenate_convert_197_7: argument 1"}
!25 = !{i32 0, i32 135456}
