...
define ptx_kernel void @gemm_fusion_dot_39_0(ptr noalias align 128 dereferenceable(41943040) %arg0, ptr noalias align 128 dereferenceable(2621440) %arg1) #0 {
...
652:                                              ; preds = %95
  ...
  %743 = add i64 %718, %739
  %744 = add i64 %718, %740
  %745 = mul i64 %741, 10240
  %746 = mul i64 %742, 10240
  %747 = mul i64 %743, 10240
  %748 = mul i64 %744, 10240
  %749 = xor i32 %25, 0
  %750 = add i32 %749, 0
...
declare ptx_kernel void @fusion_152_impl(ptr, ptr, ptr, ptr, ptr, ptr) #4
...
define ptx_kernel void @fusion_152(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(262144) %arg1, ptr noalias align 128 dereferenceable(2621440) %arg2, ptr noalias align 16 dereferenceable(2048) %arg3, ptr noalias align 128 dereferenceable(262144) %arg4) #6 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
...
define ptx_kernel void @loop_convert_fusion(ptr noalias align 128 dereferenceable(1572864) %0, ptr noalias align 128 dereferenceable(786432) %1) #0 {
  ...
  %10 = mul i32 %9, 512
  %11 = add i32 %10, %6
  %12 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %11)
  ...
  %22 = add i32 %11, 3072
  %23 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %22)
  %24 = fmul float %13, %21
  ...
  %29 = add i32 %11, 1
  %30 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %29)
  ...
  %40 = add i32 %29, 3072
  %41 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %40)
  %42 = fmul float %31, %39
  ...
  %47 = add i32 %11, 2
  %48 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %47)
  ...
  %58 = add i32 %47, 3072
  %59 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %58)
  %60 = fmul float %49, %57
  ...
  %65 = add i32 %11, 3
  %66 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %65)
  ...
  %76 = add i32 %65, 3072
  %77 = call bfloat @fused_convert_param_0_449(ptr %0, i32 %5, i32 %76)
  %78 = fmul float %67, %75
...
define internal bfloat @fused_convert_param_0_449(ptr noalias %0, i32 %1, i32 %2) {
  %4 = mul i32 %1, 6144
  %5 = add i32 %4, %2
...
declare ptx_kernel void @fusion_150_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_148_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_146_impl(ptr, ptr, ptr, ptr, ptr) #4

define ptx_kernel void @fusion_146(ptr noalias align 128 dereferenceable(524288) %arg0, ptr noalias align 16 dereferenceable(4) %arg1, ptr noalias align 16 dereferenceable(2048) %arg2, ptr noalias align 128 dereferenceable(262144) %arg3) #6 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %3 = addrspacecast ptr %arg2 to ptr addrspace(1)
  %4 = addrspacecast ptr %arg3 to ptr addrspace(1)
...
declare ptx_kernel void @fusion_144_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_142_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_134_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_132_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @triton_softmax_12_0_impl(ptr, ptr, ptr, ptr) #4

define ptx_kernel void @triton_softmax_12_0(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(1048576) %arg1, ptr noalias align 128 dereferenceable(524288) %arg2) #6 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %3 = addrspacecast ptr %arg2 to ptr addrspace(1)
