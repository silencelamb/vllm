...
define ptx_kernel void @gemm_fusion_dot_31_0(ptr noalias align 128 dereferenceable(33554432) %arg0, ptr noalias align 128 dereferenceable(2097152) %arg1) #0 {
...
401:                                              ; preds = %95
  ...
  %452 = add i64 %435, %450
  %453 = add i64 %435, %451
  %454 = mul i64 %452, 8192
  %455 = mul i64 %453, 8192
  %456 = xor i32 %25, 0
  %457 = add i32 %456, 0
...
declare ptx_kernel void @fusion_124_impl(ptr, ptr, ptr, ptr, ptr, ptr) #4
...
define ptx_kernel void @fusion_124(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(262144) %arg1, ptr noalias align 128 dereferenceable(2097152) %arg2, ptr noalias align 16 dereferenceable(2048) %arg3, ptr noalias align 128 dereferenceable(262144) %arg4) #6 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
...
define ptx_kernel void @loop_convert_fusion(ptr noalias align 128 dereferenceable(1572864) %0, ptr noalias align 128 dereferenceable(786432) %1) #0 {
  ...
  %10 = mul i32 %9, 512
  %11 = add i32 %10, %6
  %12 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %11)
  ...
  %22 = add i32 %11, 3072
  %23 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %22)
  %24 = fmul float %13, %21
  ...
  %29 = add i32 %11, 1
  %30 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %29)
  ...
  %40 = add i32 %29, 3072
  %41 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %40)
  %42 = fmul float %31, %39
  ...
  %47 = add i32 %11, 2
  %48 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %47)
  ...
  %58 = add i32 %47, 3072
  %59 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %58)
  %60 = fmul float %49, %57
  ...
  %65 = add i32 %11, 3
  %66 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %65)
  ...
  %76 = add i32 %65, 3072
  %77 = call bfloat @fused_convert_param_0_369(ptr %0, i32 %5, i32 %76)
  %78 = fmul float %67, %75
...
define internal bfloat @fused_convert_param_0_369(ptr noalias %0, i32 %1, i32 %2) {
  %4 = mul i32 %1, 6144
  %5 = add i32 %4, %2
...
declare ptx_kernel void @fusion_120_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_118_impl(ptr, ptr, ptr, ptr, ptr) #4

define ptx_kernel void @fusion_118(ptr noalias align 128 dereferenceable(524288) %arg0, ptr noalias align 16 dereferenceable(4) %arg1, ptr noalias align 16 dereferenceable(2048) %arg2, ptr noalias align 128 dereferenceable(262144) %arg3) #6 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %3 = addrspacecast ptr %arg2 to ptr addrspace(1)
  %4 = addrspacecast ptr %arg3 to ptr addrspace(1)
...
define ptx_kernel void @loop_add_fusion_1(ptr noalias align 128 dereferenceable(2097152) %0, ptr noalias align 128 dereferenceable(262144) %1, ptr noalias align 128 dereferenceable(524288) %2, ptr noalias align 128 dereferenceable(262144) %3) #0 {
  ...
  %20 = add i32 %10, 3072
  %21 = call float @fused_add_1_convert_429_20(ptr %0, ptr %1, ptr %2, ptr %3, i32 %7, i32 %20)
  %22 = fadd float %15, %17
  %23 = fpext bfloat %19 to float
  %24 = fadd float %21, %22
  %25 = add i32 %10, 2048
  %26 = call float @fused_add_1_convert_429_20(ptr %0, ptr %1, ptr %2, ptr %3, i32 %7, i32 %25)
  %27 = fadd float %23, %24
  %28 = fadd float %26, %27
...
define internal float @fused_add_1_convert_429_20(ptr noalias %0, ptr noalias %1, ptr noalias %2, ptr noalias %3, i32 %4, i32 %5) {
  %7 = mul i32 %4, 8192
  %8 = add i32 %7, %5
...
declare ptx_kernel void @fusion_112_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_110_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @fusion_108_impl(ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr) #4
...
declare ptx_kernel void @triton_softmax_10_0_impl(ptr, ptr, ptr, ptr) #4

define ptx_kernel void @triton_softmax_10_0(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(1048576) %arg1, ptr noalias align 128 dereferenceable(524288) %arg2) #6 {
  %1 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %2 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %3 = addrspacecast ptr %arg2 to ptr addrspace(1)
